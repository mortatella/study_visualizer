...
// Um Objekte aus der Datenbank zu holen muss zudem noch TSFE initialisiert werden
$temp_TSFEclassName = t3lib_div::getClassName('tslib_fe');
$TSFE = new $temp_TSFEclassName('tslib_fe', $page, 0, true);
$GLOBALS['TSFE'] = $TSFE;
